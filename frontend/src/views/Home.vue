      ...
      <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        ...
        <div class="mb-16">
          ...
          <p class="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto mb-8">
            Connect with qualified providers online for sessions, recommendations, and medical advice from the comfort
            of your home.
          </p>
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
            Experience healthcare reimagined with our comprehensive online medical session platform.
          </p>
        </div>
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">Join your secure video session and receive professional medical care from the
    ...
    <div class="py-20 medical-gradient">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Join thousands of clients who have already discovered the convenience and quality of online medical
          sessions.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
          <router-link to="/register"
