                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input id="search" v-model="filters.name" type="text" class="input mt-1"
                            placeholder="Search doctors..." @input="handleSearch" />
                    </div>
                    <div>
                        <label for="specialization" class="label">Specialization</label>
                        <select id="specialization" v-model="filters.specialization" class="input mt-1"
                            @change="handleSearch">
                        ...
                        <div v-for="doctor in doctors" :key="doctor._id"
                            ...
                            <div class="p-6">
                                <div class="flex items-center space-x-4">
                                    <img :src="doctor.profilePicture || 'https://via.placeholder.com/100'"
                                        :alt="doctor.firstName" class="h-16 w-16 rounded-full object-cover" />
                                    <div>
